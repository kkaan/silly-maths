...
const STORY_BEATS = {
  ...
  4: {
    ...
    lines: [
      { char: 'narrator', text: 'While Sage and Fluffy argued about whether you could technically eat a bookmark ("It\'s just thin paper, Sage!"), {PLAYER} wandered deeper into the library.' },
      { char: 'narrator', text: 'At the very back, on a shelf half-hidden by shadow, a single book pulsed with a faint purple glow. Its cover was dark leather, sealed with a symbol {PLAYER} didn\'t recognise \u2014 a spiral of thorns around a crescent moon.' },
      { char: 'narrator', text: '{PLAYER} opened it. The first page read: "The Arts of Grimoria \u2014 Volume I: Shadow Maths and the Power of Confusion." The letters seemed to squirm on the page.' },
      { char: 'narrator', text: '"When numbers are obscured and logic is clouded, the mind becomes fertile ground for\u2014"' },
      { char: 'fluffy', text: 'WHOA whoa whoa!' },
      { char: 'narrator', text: 'Fluffy appeared out of nowhere and gently nudged the book closed with her nose.' },
      { char: 'fluffy', text: 'Hey, {PLAYER}\u2026 that\'s from the Restricted Section. Grimoria stuff. It\'s not\u2026 BAD exactly, but it\'s\u2026 a lot. Maybe a bit much for right now?' },
      { char: 'sage', text: 'Fluffy is right, {PLAYER}. There will be time for those darker chapters when you\'re an Apprentice. You\'ll understand them better then. For now, there are lighter things to learn.' },
      { char: 'fluffy', text: 'LIKE THIS ONE!' },
      { char: 'narrator', text: 'Fluffy proudly knocked a bright pink book off the shelf with her horn. The title read: "The Complete Guide to Desserts for Unicorns \u2014 387 Recipes Including Skittle Souffl\u00e9."' },
      { char: 'fluffy', text: 'Page 42 has a recipe for skittle pancakes. Page 103 has skittle ice cream. Page 200 is just a picture of skittles. It\'s my FAVOURITE page.' },
      { char: 'sage', text: 'She\'s checked that book out forty-seven times. I stopped counting after that.' },
      { char: 'fluffy', text: 'FORTY-EIGHT. I took it home last Tuesday. You were asleep.' },
    ],
  },
  5: {
...
const MID_LEVEL_BEATS = {
  ...
  3: { title: 'The Librarian', lines: [
    ...
    { char: 'fluffy', text: 'Ooh! The LIBRARY! {PLAYER}, come on, I want you to meet someone!' },
    { char: 'narrator', text: 'Fluffy trotted inside like she owned the place. Behind a towering desk sat an elderly fairy with spectacles perched on her nose and ink-stained fingers.' },
    { char: 'sage', text: 'Well well well. If it isn\'t Fluffy. I haven\'t seen you since you ate the corner of my Encyclopedia of Prime Numbers.' },
    { char: 'fluffy', text: 'It was ONE corner! And it was DELICIOUS! Sage, this is {PLAYER}! They fell through a portal and now they\'re saving Mathlandia with MATHS!' },
    { char: 'sage', text: 'A human! How wonderful. I am Sage, the Royal Librarian. I have catalogued every book in this library \u2014 every book has its number, and every number has its place.' },
    { char: 'fluffy', text: 'Sage taught me to read when I was a tiny foal! I used to sneak in after bedtime and she\'d let me look at the picture books about constellations.' },
    { char: 'sage', text: 'You fell asleep on a stack of atlases every single time. Drooled on three of them.' },
    { char: 'fluffy', text: 'They were COMFORTABLE atlases! Anyway \u2014 {PLAYER}, Sage knows EVERYTHING. If you ever need answers, come here.' },
    { char: 'sage', text: 'Welcome to Mathlandia, {PLAYER}. Knowledge is free. Unlike skittles.' },
    { char: 'fluffy', text: '\u2026Why does EVERYONE keep saying that?' },
  ]},
...
const LIFE_BEATS = {
  ...
  3: {
    title: 'The Beautiful Books',
    lines: [
      { char: 'narrator', text: 'Sage led {PLAYER} and Fluffy deeper into the library. The shelves spiralled upward like a nautilus shell, each level older and more mysterious than the last.' },
      { char: 'sage', text: 'This floor is measurements. That floor is shapes. And up THERE\u2026' },
      { char: 'narrator', text: 'Sage pulled a book from a high shelf. Its cover shimmered with golden equations that rearranged themselves as {PLAYER} watched.' },
      { char: 'sage', text: '"The Fairy Wand \u2014 A Mathematical History." Every wand ever made was tuned using precise ratios. The length of the shaft, the angle of the crystal, the weight of the handle \u2014 all calculated to channel magic perfectly.' },
      { char: 'fluffy', text: 'Ooh ooh! Show them the UNICORN section!' },
      { char: 'narrator', text: 'Fluffy dragged {PLAYER} to a glowing alcove filled with illustrated volumes. One book showed unicorn horns in cross-section \u2014 spiralling in perfect logarithmic curves.' },
      { char: 'sage', text: 'Unicorn horns grow following the golden ratio. Every unicorn is a living mathematical wonder. Including this one, who once tried to eat a geometry textbook.' },
      { char: 'fluffy', text: 'It had a TRIANGLE on the cover! I thought it was a SANDWICH! Sage, you KNOW I get confused by triangles!' },
      { char: 'sage', text: 'You get confused by anything vaguely wedge-shaped, dear.' },
      { char: 'fluffy', text: '{PLAYER}, did you know my horn is exactly 1.618 times the length of my ear? That\'s the golden ratio! I measured! Well\u2026 Sage measured. I held still. Mostly.' },
    ],
  },
  5: {
